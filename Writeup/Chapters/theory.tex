...
This eliminates the need to compute a tangent linear and adjoint model, which is a computationally expensive aspect of most variational data assimilation schemes \citep{Bannister2017}.
